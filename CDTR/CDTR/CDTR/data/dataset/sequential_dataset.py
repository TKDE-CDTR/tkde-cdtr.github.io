...
from CDTR.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~CDTR.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~CDTR.config.eval_setting.EvalSetting`):
