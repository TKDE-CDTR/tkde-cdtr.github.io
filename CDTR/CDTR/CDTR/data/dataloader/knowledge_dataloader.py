...
"""
CDTR.data.dataloader.knowledge_dataloader
################################################
"""
from CDTR.data.dataloader.abstract_dataloader import AbstractDataLoader
from CDTR.data.dataloader.general_dataloader import TrainDataLoader
from CDTR.data.interaction import Interaction
from CDTR.utils import InputType, KGDataLoaderState
...
class KnowledgeBasedDataLoader(AbstractDataLoader):
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~CDTR.data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                ...
                - :obj:`~CDTR.utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~CDTR.utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~CDTR.utils.enum_type.KGDataLoaderState.RSKG`
