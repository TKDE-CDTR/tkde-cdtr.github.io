...
from CDTR.data.dataloader import *
from CDTR.sampler import KGSampler, Sampler, RepeatableSampler
from CDTR.utils import ModelType, ensure_dir, get_local_time, set_color
from CDTR.utils.argument_list import dataset_arguments
...
def create_dataset(config):
    ...
    """
    dataset_module = importlib.import_module('CDTR.data.dataset')
